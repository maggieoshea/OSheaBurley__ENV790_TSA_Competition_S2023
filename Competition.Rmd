...
## Compiling Accuracy Calculation
# Accuracy not working because 'start' cannot be after 'end' --> not sure what's going on! 
```{r}
#Model 1: ARIMA with Fourier 
ARIMA_f_scores <- accuracy(ARIMA_Fourier_forecast$mean, ts_demand_train) 

#Model 2: STL+ETS
ETS_scores <- accuracy(ETS_fit$mean, ts_demand_train)
```
